...
class SalesforceSoap < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "http://dchasman-ws1:8001/services/Soap/u/8.0"
  ...
  Methods = [
    ...
    [ "",
      "upsert",
      [ ["in", "parameters", ["::SOAP::SOAPElement", "urn:partner.soap.sforce.com", "upsert"], true],
        ["out", "parameters", ["::SOAP::SOAPElement", "urn:partner.soap.sforce.com", "upsertResponse"], true] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal }
    ],
    [ "",
    ...
    [ "",
      "processSubmit",
      [ ["in", "parameters", ["::SOAP::SOAPElement", "urn:partner.soap.sforce.com", "processSubmit"], true],
        ["out", "parameters", ["::SOAP::SOAPElement", "urn:partner.soap.sforce.com", "processSubmitResponse"], true] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal }
    ],
    [ "",
      "processWorkitem",
      [ ["in", "parameters", ["::SOAP::SOAPElement", "urn:partner.soap.sforce.com", "processWorkitem"], true],
        ["out", "parameters", ["::SOAP::SOAPElement", "urn:partner.soap.sforce.com", "processWorkitemResponse"], true] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal }
    ],
    [ "",
